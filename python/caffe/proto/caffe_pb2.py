...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='roi_pooling_st_param', full_name='caffe.LayerParameter.roi_pooling_st_param', index=56,
...
_ROIPOOLINGSTPARAMETER = _descriptor.Descriptor(
  name='ROIPoolingStParameter',
  full_name='caffe.ROIPoolingStParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pooled_h', full_name='caffe.ROIPoolingStParameter.pooled_h', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='pooled_w', full_name='caffe.ROIPoolingStParameter.pooled_w', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='spatial_scale', full_name='caffe.ROIPoolingStParameter.spatial_scale', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['roi_pooling_st_param'].message_type = _ROIPOOLINGSTPARAMETER
...
DESCRIPTOR.message_types_by_name['ROIPoolingStParameter'] = _ROIPOOLINGSTPARAMETER
...
class ROIPoolingStParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ROIPOOLINGSTPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.ROIPoolingStParameter)
